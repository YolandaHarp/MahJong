...
public class DotScreen implements ChooseDrawable {
    ...
    static void drawDot(GraphicsContext g, double x, double y, int i, int j, int h, double a, Color color, int k){
    ...
    static void draw3Dot(GraphicsContext g, double x, double y, double a, Color color){//3 on a line
        drawDot(g, x, y, 473, 491, 18, a, color, 4);
        drawDot(g, x, y, 491, 491, 18, a, color, 4);
        drawDot(g, x, y, 509, 491, 18, a, color, 4);
    }
    static void draw4Dot(GraphicsContext g, double x, double y, double a, Color color){//4 as a square
