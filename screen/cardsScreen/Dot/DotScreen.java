...
public class DotScreen implements ChooseDrawable {
    ...
    private Drawable[] dots= new Drawable[]{new MJ0(),new MJ1(),new MJ2(),new MJ3(),new MJ4(),new MJ5(),new MJ6(),new MJ7(),new MJ8()};
    private DotScreen(){}
    public static DotScreen getDot(){
        return dot;
    }
    protected static void drawDot(GraphicsContext g, double x, double y, int i, int j, int h, double a, Color color, int k){
    ...
    protected static void draw3Dot(GraphicsContext g, double x, double y, double a, Color color){//3 on a line
        drawDot(g, x, y, 473, 491, 18, a, color, 4);
        drawDot(g, x, y, 491, 491, 18, a, color, 4);
        drawDot(g, x, y, 509, 491, 18, a, color, 4);
    }
    protected static void draw4Dot(GraphicsContext g, double x, double y, double a, Color color){//4 as a square
