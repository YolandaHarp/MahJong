...
class MJ29 implements Drawable {
    @Override
    public void draw(GraphicsContext g, double x, double y, double a) {
        ...
        drawPg(g, x_coords, y_coords, (x-2*a), (y+4*a), 0.9*a, white, Color.BLACK, 4.0f);
        ...
        drawPg(g, x_coords2, y_coords2, x,(y+35*a), 1.05*a, white, Color.BLACK, 5.2f);
        ...
        drawPg(g, x_coords5, y_coords5, (x-2*a), (y-1*a), a, white, Color.BLACK, 4.6f);
    }
}
