...
public class CardScreen {
    ...
    public static void drawPg(GraphicsContext g, int[] x_coords, int[] y_coords, int x, int y, double a, Color color1, Color color2, float f) {
    ...
    public static void drawO(GraphicsContext g, int x, int y, int i, int j, int h, double a, Color color1, Color color2, float f) {
        double oldLineWidth = g.getLineWidth();
        g.setLineWidth(f * a);
        g.setFill(color1);
        g.setStroke(color2);
        g.fillOval((int) (x - (500 - i) * a), (int) (y - (500 - j) * a), (int) (h * a), (int) (h * a));
        g.strokeOval((int) (x - (500 - i) * a), (int) (y - (500 - j) * a), (int) (h * a), (int) (h * a));
        g.setLineWidth(oldLineWidth);
    }
    void drawDown(GraphicsContext g, int x, int y, double a) {
        ...
        drawPg(g, x_coords, y_coords, x, y, a, Color.rgb(80, 180, 30), white, 1.0f);
    ...
    void drawCardFlank(GraphicsContext g, int x, int y, double a) {
        ...
        drawPg(g, x_coords, y_coords, x, y, a, Color.rgb(100, 200, 50), white, 1.0f);
    }
    ...
    public void drawCardUpper(GraphicsContext g, int x, int y, double a) {
        ...
        drawPg(g, x_coords, y_coords, x, y, a, white, Color.BLACK, 1.0f);
    }

    void drawCardUpperLeft(GraphicsContext g, int x, int y, double a) {
    ...
    void drawCardUpperRight(GraphicsContext g, int x, int y, double a) {
        drawCardUpper(g, x, y, a);
        int[] x_coords = new int[]{9, 13, 13, 9};
    ...
    public void drawCardFront(GraphicsContext g, int x, int y, double a) {
        int[] x_coords = new int[]{30, 34, 34, 30, -30, -34, -34, -30};
        int[] y_coords = new int[]{48, 44, -44, -48, -48, -44, 44, 48};
        drawPg(g, x_coords, y_coords, x, y, a, Color.rgb(230, 230, 230), Color.BLACK, 2.0f);
    }
    ...
    void drawCardBack(GraphicsContext g, int x, int y, double a) {
        int[] x_coords = new int[]{30, 34, 34, 30, -30, -34, -34, -30};
        int[] y_coords = new int[]{48, 44, -44, -48, -48, -44, 44, 48};
        drawPg(g, x_coords, y_coords, x, y, a, Color.rgb(150, 200, 50), white, 1.0f);
